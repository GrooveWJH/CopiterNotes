...
| LAND_SPEED_HIGH                                              | The descent speed for the first stage of landing in<br/>cm/s. If this is Zero then WPNAV SPEED DN is used |        |
| WPNAV_SPEED_DN                                               | Waypoint descent speed Target (10-500 m/s)，航点着陆下降速率 | 150    |
| PLND_ ENABLED                                                | Enabled Always Land<br/>Precision Land enabled/disabled and behaviour |        |
| PILOT_ACCEL_Z                                                | 垂直方向加速度(50-500 m/s/s)                                 | 50     |
| PILOT_ACCEL_MAX                                              | 垂直方向最大速度(50-500 m/s)                                 | 70     |
| RC_FEEL_RP                                                   | 控制俯仰的灵敏度                                             | Soft   |
|                                                              |                                                              |        |
|                                                              |                                                              |        |
|                                                              |                                                              |        |
|                                                              |                                                              |        |
